...
public class Pelicula {
	...
	//Esta anotacion intenta hacer una autoinyeccion de la misma manera
	//que el autowire por xml, pero su comportamiento por defecto es:
	//1- Intenta hacer un autowired por type "byType"
	//2- Si hubiera varios objetos del mismo tipo, entonces hace un autowired
	//por nombre "byName"
	@Autowired
