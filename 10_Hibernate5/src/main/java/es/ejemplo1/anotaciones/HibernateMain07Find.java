...
public class HibernateMain07Find {
	...
	public static void main(String[] args) {
		...
		//el metodo find() de JPA funciona igual que el metodo get() de Hibernate
		Persona p1 = session.find(Persona.class, 1);
		System.out.println(p1);
		System.out.println("Esta en la cache p1? " + session.contains(p1));
		System.out.println("Quitamos el objeto p1 de la cache");
		session.detach(p1);//Es un clear() pero solo del objeto que queramos
		System.out.println("Esta en la cache p1? " + session.contains(p1));
		p1 = session.find(Persona.class, 1);
		System.out.println("Esta en la cache p1? " + session.contains(p1));
		System.out.println(p1);
		...
		p1 = session.find(Persona.class, 1);//Hariamos otra vez la consulta
		System.out.println(p1);
		...
		p1 = session.find(Persona.class, 2);
		System.out.println(p1);
