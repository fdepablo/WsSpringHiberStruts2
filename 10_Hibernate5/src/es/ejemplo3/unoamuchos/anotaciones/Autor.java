...
public class Autor{
	...
	//En relaciones "@OneToMany" es importante quién es el dueño de la 
	//relación, ya que es el dueño quien determina como debe actuar
	//el el motor de persistencia

	//El dueño SIEMPRE esta en el lado muchos (esta es una regla). 
	//Por lo que en este caso el dueño de la relación es la clase "Libro".
