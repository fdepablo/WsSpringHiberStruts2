...
El objeto que se va a encargar de el mapeo de la base de datos con nuestra aplicacion se llama Entity Manager, y es el objeto más importante en nuetra aplicacion para el mapeo. En hibernate se llama SESSION y actua muy muy muy muy parecido al Entity Manager de JPA
